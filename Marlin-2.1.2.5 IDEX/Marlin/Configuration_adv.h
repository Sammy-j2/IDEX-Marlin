 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 40     // (°C)
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS    65        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS   297.75        // The max position of the X2 carriage, typically also the home position
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC   1  // (steps/s) Encoder rate for 10x speed
  #define ENCODER_100X_STEPS_PER_SEC  1  // (steps/s) Encoder rate for 100x speed
#endif
