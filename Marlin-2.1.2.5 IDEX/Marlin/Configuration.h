...
#define STRING_CONFIG_H_AUTHOR "(SammyJ)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Duel Extruder"
...
#define HOTEND_OFFSET_X { 0.0, 297.25 } // (mm) relative X-offset for each nozzle THIS WAS CHANGED BY YOU AND MAY BE WRONG
#define HOTEND_OFFSET_Y { 0.0, -10.50 }  // (mm) relative Y-offset for each nozzle THIS WAS CHANGED BY YOU AND MAY BE WRONG
#define HOTEND_OFFSET_Z { 0.0, 0.00 }  // (mm) relative Z-offset for each nozzle THIS WAS CHANGED BY YOU AND MAY BE WRONG
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  4.20,  22.20 }
    #define DEFAULT_Ki_LIST {   .36,   1.08 }
    #define DEFAULT_Kd_LIST { 12.40, 114.00 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 272, 272 }
...
#define PREHEAT_3_LABEL       "CARBON FIBER"
